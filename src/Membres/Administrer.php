...
EOF;
	 ...
	 * @return array $user (tableau associatif) ou null
	 */
	public function mettreAJour($id, $newpseudo, $newmail, $actuMdp, $newage, $newmdp1, $newmdp2)
	{
	...
	public function envoyerMail($destinataire, $sujet, $message)
	{
		...
		$mail->Username = "bcainjo123@gmail.com"; // Identifiant du compte SMTP
		$mail->Password = "gnFR3hj9s015yWbP"; // Mot de passe du compte SMTP
		// Destinataires
		$mail->setFrom("contact@ecostara.fr", 'EcoStara');
